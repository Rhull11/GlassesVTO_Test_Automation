...
public class TestTapForFavoriting {
	...
	public void test() {
		...
		Scenes.HowWouldYouLikeToShopToday.TapFramesOnly(wd);
		Scenes.ShoppingScreen.TapFavoriteFrame(wd);
		Scenes.BottomNavBar.TapFavoritesButton(wd);
